...
public class GenerarEntradas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GenerarEntradas
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GenerarEntradas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GenerarEntradas().setVisible(true);
            }
        });
    }
